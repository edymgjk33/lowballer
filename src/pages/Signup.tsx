      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="border-0 shadow-2xl bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl border border-white/20">
          <CardHeader className="pb-8">
            <CardTitle className="text-4xl text-center font-black text-gray-900">Create Account</CardTitle>
            <p className="text-center text-gray-700 mt-3 text-lg font-bold">Start saving money today</p>
          </CardHeader>
          <CardContent className="px-8 pb-8">
            ...
            <div className="mt-10 text-center space-y-6">
              <p className="text-lg text-gray-700 font-bold">
                ...
                <Link to="/login" className="text-emerald-600 hover:text-emerald-700 font-black transition-colors">
                  Sign in
                </Link>
              </p>
